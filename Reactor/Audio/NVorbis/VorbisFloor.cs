    ...
    internal abstract class VorbisFloor
    {
        ...
        internal abstract class PacketData
        {
            ...
            internal bool ExecuteChannel =>
                ...
                (ForceEnergy | HasEnergy) & !ForceNoEnergy;
        }
        ...
        private class Floor0 : VorbisFloor
        {
            ...
            {
                return (float)(13.1 * Math.Atan(0.00074 * lsp) + 2.24 * Math.Atan(0.0000000185 * lsp * lsp) +
                               .0001 * lsp);
            }
        ...
        private class Floor1 : VorbisFloor
        {
            ...
            protected override void Init(DataPacket packet)
            {
                ...
                for (var i = 0; i < _partitionClass.Length; i++) _partitionClass[i] = (int)packet.ReadBits(4);
                ...
                for (var i = 0; i < _reusablePacketData.Length; i++) _reusablePacketData[i] = new PacketData1();
            }
            ...
            private bool[] UnwrapPosts(PacketData1 data)
            {
                ...
                for (var i = 2; i < data.PostCount; i++)
                {
                    ...
                    var predicted = RenderPoint(_xList[lowOfs], _finalY[lowOfs], _xList[highOfs], _finalY[highOfs],
                        _xList[i]);
                ...
                for (var i = 0; i < data.PostCount; i++) data.Posts[i] = _finalY[i];
