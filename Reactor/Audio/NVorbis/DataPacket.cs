...
namespace NVorbis
{
    ...
    public abstract class DataPacket
    {
        ...
        public int? GranuleCount
        {
            get
            {
                if (GetFlag(PacketFlags.HasGranuleCount)) return _granuleCount;
                return null;
            }
            set
            {
        ...
        /// <summary>
        ///     Attempts to read the specified number of bits from the packet, but may return fewer.  Does not advance the position
        ///     counter.
        /// </summary>
        ...
        public byte[] ReadBytes(int count)
        {
            ...
            while (buf.Count < count) buf.Add(ReadByte());
        ...
        ///     <paramref name="count" /> is past the end of <paramref name="buffer" />.
        /// </exception>
