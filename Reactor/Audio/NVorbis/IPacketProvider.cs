...
namespace NVorbis
{
    ...
    public interface IPacketProvider : IDisposable
    {
        ...
        ///     <paramref name="packetIndex" /> is less than 0 or past the end of the
        ///     stream.
        /// </exception>
        /// <exception cref="InvalidOperationException"><see cref="CanSeek" /> is <c>False</c>.</exception>
        ...
        /// <param name="packetGranuleCountCallback">
        ///     A callback method that takes the current and previous packets and returns the
        ///     number of granules in the current packet.
        /// </param>
        /// <returns>The index of the packet that includes the specified granule position or -1 if none found.</returns>
        /// <exception cref="ArgumentOutOfRangeException">
        ///     <paramref name="granulePos" /> is less than 0 or is after the last
        ///     granule.
        /// </exception>
