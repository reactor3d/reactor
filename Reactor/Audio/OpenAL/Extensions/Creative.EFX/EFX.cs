...
namespace Reactor.Audio.OpenAL
{
    public partial class ALC
    {
        ...
        public class EFX : ALBase
        {
            ...
            {
                GetEffect(effect, param, out var result);
                return result;
            }
            ...
            {
                GetFilter(filter, param, out var result);
                return result;
            }
            ...
            {
                GetSource(source, param, out var result);
                return result;
            }
            ...
            {
                GetListener(listener, param, out var result);
                return result;
            }
...
#pragma warning disable SA1516 // Elements should be separated by blank line
            ...
            [UnmanagedFunctionPointer(AL.ALCallingConvention)]
            private unsafe delegate void GetAuxiliaryEffectSlotiPtrDelegate(int slot, EffectSlotInteger param,
                int* value);
            ...
            [UnmanagedFunctionPointer(AL.ALCallingConvention)]
            private unsafe delegate void GetAuxiliaryEffectSlotfPtrDelegate(int slot, EffectSlotFloat param,
                float* value);
            ...
            private static readonly EffectfvArrayDelegate _EffectfvArray =
                LoadDelegate<EffectfvArrayDelegate>("alEffectfv");
            ...
            private static readonly SourceivArrayDelegate _SourceivArray =
                LoadDelegate<SourceivArrayDelegate>("alSourceiv");
            ...
            [UnmanagedFunctionPointer(AL.ALCallingConvention)]
            private delegate void Source3iDelegate(int source, EFXSourceInteger3 param, int value1, int value2,
                int value3);
            ...
            /// <param name="value2">The second value to set the property to.</param>
            /// <param name="value3">The third value to set the property to.</param>
            public static unsafe void GetSource(int source, EFXSourceInteger3 param, int* value1, int* value2,
                int* value3)
            {
