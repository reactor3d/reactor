...
namespace Reactor.Audio.OpenAL
{
    public partial class AL
    {
        public class SourceLatency : ALBase
        {
            ...
            public static unsafe void GetSource(int source, SourceLatencyVector2i param, out long value1,
                out long value2)
            {
            ...
            public static void GetSource(int source, SourceLatencyVector2d param, out Vector2 values)
            {
                values.Y = default;
                double d;
                GetSource(source, param, out d);
                values.X = (float)d;
            }
...
#pragma warning disable SA1516 // Elements should be separated by blank line
            ...
            [UnmanagedFunctionPointer(ALCallingConvention)]
            private unsafe delegate void
                GetSourcei64vPtrDelegate(int source, SourceLatencyVector2i param, long* values);
            ...
            [UnmanagedFunctionPointer(ALCallingConvention)]
            private unsafe delegate void
                GetSourcedvPtrDelegate(int source, SourceLatencyVector2d param, double* values);
