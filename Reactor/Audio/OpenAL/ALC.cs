...
namespace Reactor.Audio.OpenAL
{
    ...
    public partial class ALC : ALBase
    {
        ...
        ///     A zero terminated array of a set of attributes: ALC_FREQUENCY, ALC_MONO_SOURCES,
        ///     ALC_REFRESH, ALC_STEREO_SOURCES, ALC_SYNC.
        /// </param>
        ...
        public static extern unsafe ALContext CreateContext([In] ALDevice device, [In] int* attributeList);
        ...
        /// <param name="device">A pointer to a device.</param>
        /// <param name="attributeList">
        ///     A zero terminated span of a set of attributes: ALC_FREQUENCY, ALC_MONO_SOURCES,
        ///     ALC_REFRESH, ALC_STEREO_SOURCES, ALC_SYNC.
        /// </param>
        /// <returns>Returns a pointer to the new context (NULL on failure).</returns>
        /// <remarks>
        ...
        [DllImport(Lib, EntryPoint = "alcOpenDevice", ExactSpelling = true, CallingConvention = AlcCallingConv,
        ...
        [DllImport(Lib, EntryPoint = "alcIsExtensionPresent", ExactSpelling = true, CallingConvention = AlcCallingConv,
            CharSet = CharSet.Ansi)]
        ...
        [DllImport(Lib, EntryPoint = "alcGetProcAddress", ExactSpelling = true, CallingConvention = AlcCallingConv,
            CharSet = CharSet.Ansi)]
        ...
        /// </returns>
        [DllImport(Lib, EntryPoint = "alcGetEnumValue", ExactSpelling = true, CallingConvention = AlcCallingConv,
            CharSet = CharSet.Ansi)]
        ...
        [DllImport(Lib, EntryPoint = "alcGetIntegerv", ExactSpelling = true, CallingConvention = AlcCallingConv,
            CharSet = CharSet.Ansi)]
        ...
        {
            GetInteger(device, param, 1, out var data);
            return data;
        }
        ...
        {
            GetInteger(device, AlcGetInteger.AttributesSize, 1, out var size);
        ...
        [DllImport(Lib, EntryPoint = "alcCaptureOpenDevice", ExactSpelling = true, CallingConvention = AlcCallingConv,
            CharSet = CharSet.Ansi)]
        public static extern ALCaptureDevice CaptureOpenDevice(string devicename, uint frequency, ALFormat format,
            int buffersize);
        ...
        [DllImport(Lib, EntryPoint = "alcCaptureOpenDevice", ExactSpelling = true, CallingConvention = AlcCallingConv,
            CharSet = CharSet.Ansi)]
        public static extern ALCaptureDevice CaptureOpenDevice(string devicename, int frequency, ALFormat format,
            int buffersize);
        // ALC_API ALCdevice*      ALC_APIENTRY alcCaptureOpenDevice( const ALCchar *devicename, ALCuint frequency, ALCenum format, ALCsizei buffersize );
        ...
        {
            GetInteger(device, param, 1, out var value);
            return value;
        }
