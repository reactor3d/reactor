...
namespace Reactor.Graphics
{
    ...
    public class GraphicsMode : IEquatable<GraphicsMode>
    {
        ...
        /// <summary>
        /// Gets an Reactor.Graphics.ColorFormat that describes the color format for this GraphicsFormat.
        /// </summary>
        public ColorFormat ColorFormat { get; private set; }

        /// <summary>
        /// Gets an Reactor.Graphics.ColorFormat that describes the accumulator format for this GraphicsFormat.
        /// </summary>
        ...
        /// <summary>Returns an Reactor.GraphicsFormat compatible with the underlying platform.</summary>
