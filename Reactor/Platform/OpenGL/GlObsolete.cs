...
namespace Reactor.Platform.OpenGL
{
    partial class GL
    {
        ...
        public static void GetSamplerParameterfv(uint sampler, int pname, [OutAttribute] float[] @params)
        {
        ...
        public static void GetSamplerParameteriv(uint sampler, int pname, [OutAttribute] int[] @params)
        {
