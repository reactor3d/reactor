...
namespace Reactor.Platform.OpenGL
{
    ...
    partial class GL
    {
        ...
        ///     NULL.
        /// </param>
        public static void BindBuffersRange(BufferTarget target, uint first, int count, uint[] buffers,
        ...
        ///     stores.
        /// </param>
        public static void BindImageTexture(uint unit, uint texture, int level, bool layered, int layer,
        ...
        ///     The distance between elements within the buffer.
        /// </param>
        public static void VertexArrayVertexBuffer(uint vaobj, uint bindingindex, uint buffer, IntPtr offset,
            int stride)
        {
        ...
        ///     Specifies the address of an array of strides to associate with the binding points.
        /// </param>
        public static void VertexArrayVertexBuffers(uint vaobj, uint first, int count, uint[] buffers, IntPtr[] offsets,
            int[] strides)
        {
        ...
        /// </param>
        public static void BlendFuncSeparate(BlendingFactorSrc srcRGB, BlendingFactorDest dstRGB,
        ...
        ///     Specified how the alpha destination blending factor is computed. The initial value is GL_ZERO.
        /// </param>
        public static void BlendFuncSeparatei(uint buf, BlendingFactorSrc srcRGB, BlendingFactorDest dstRGB,
            BlendingFactorSrc srcAlpha, BlendingFactorDest dstAlpha)
        {
        ...
        {
            Delegates.glBlitNamedFramebuffer(readFramebuffer, drawFramebuffer, srcX0, srcY0, srcX1, srcY1, dstX0, dstY0,
        ...
        ///     The value to clear the stencil buffer to.
        /// </param>
        public static void ClearNamedFramebufferfi(uint framebuffer, ClearBuffer buffer, int drawbuffer, float depth,
            int stencil)
        {
        ...
        /// </param>
        public static void ClearBufferData(BufferTarget target, SizedInternalFormat internalFormat,
        ...
        ///     The address of a memory location storing the data to be replicated into the buffer's data store.
        /// </param>
        public static void ClearNamedBufferData(uint buffer, SizedInternalFormat internalFormat,
            PixelInternalFormat format, PixelType type, IntPtr data)
        {
        ...
        ///     The address of a memory location storing the data to be replicated into the buffer's data store.
        /// </param>
        public static void ClearBufferSubData(BufferTarget target, SizedInternalFormat internalFormat, IntPtr offset,
            IntPtr size, PixelInternalFormat format, PixelType type, IntPtr data)
        {
        ...
        ///     The address of a memory location storing the data to be replicated into the buffer's data store.
        /// </param>
        public static void ClearNamedBufferSubData(uint buffer, SizedInternalFormat internalFormat, IntPtr offset,
            int size, PixelInternalFormat format, PixelType type, IntPtr data)
        {
        ...
        /// </param>
        public static void ClearTexImage(uint texture, int level, PixelInternalFormat format, PixelType type,
            IntPtr data)
        {
        ...
        public static void ClearTexSubImage(uint texture, int level, int xoffset, int yoffset, int zoffset, int width,
            int height, int depth, PixelInternalFormat format, PixelType type, IntPtr data)
        {
            Delegates.glClearTexSubImage(texture, level, xoffset, yoffset, zoffset, width, height, depth, format, type,
                data);
        }
        ...
        {
            Delegates.glCompressedTexImage3D(target, level, internalFormat, width, height, depth, border, imageSize,
                data);
        }
        ...
        public static void CompressedTexSubImage2D(TextureTarget target, int level, int xoffset, int yoffset, int width,
            int height, PixelFormat format, int imageSize, IntPtr data)
        {
            Delegates.glCompressedTexSubImage2D(target, level, xoffset, yoffset, width, height, format, imageSize,
                data);
        }
        ...
        public static void CompressedTextureSubImage2D(uint texture, int level, int xoffset, int yoffset, int width,
            int height, PixelInternalFormat format, int imageSize, IntPtr data)
        {
            Delegates.glCompressedTextureSubImage2D(texture, level, xoffset, yoffset, width, height, format, imageSize,
                data);
        }
        ...
        {
            Delegates.glCompressedTexSubImage3D(target, level, xoffset, yoffset, zoffset, width, height, depth, format,
                imageSize, data);
        }
        ...
        public static void CompressedTextureSubImage3D(uint texture, int level, int xoffset, int yoffset, int zoffset,
            int width, int height, int depth, PixelInternalFormat format, int imageSize, IntPtr data)
        {
            Delegates.glCompressedTextureSubImage3D(texture, level, xoffset, yoffset, zoffset, width, height, depth,
        ...
        /// </param>
        public static void CopyBufferSubData(BufferTarget readTarget, BufferTarget writeTarget, IntPtr readOffset,
        ...
        ///     to the destination buffer object.
        /// </param>
        public static void CopyNamedBufferSubData(uint readBuffer, uint writeBuffer, IntPtr readOffset,
        ...
        /// </param>
        public static void CopyImageSubData(uint srcName, BufferTarget srcTarget, int srcLevel, int srcX, int srcY,
        ...
        {
            Delegates.glCopyImageSubData(srcName, srcTarget, srcLevel, srcX, srcY, srcZ, dstName, dstTarget, dstLevel,
        ...
        ///     Must be 0.
        /// </param>
        public static void CopyTexImage1D(TextureTarget target, int level, PixelInternalFormat internalFormat, int x,
        ...
        ///     Must be 0.
        /// </param>
        public static void CopyTexImage2D(TextureTarget target, int level, PixelInternalFormat internalFormat, int x,
        ...
        ///     Specifies the height of the texture subimage.
        /// </param>
        public static void CopyTexSubImage2D(TextureTarget target, int level, int xoffset, int yoffset, int x, int y,
        ...
        ///     Specifies the height of the texture subimage.
        /// </param>
        public static void CopyTextureSubImage2D(uint texture, int level, int xoffset, int yoffset, int x, int y,
            int width, int height)
        {
        ...
        ///     Specifies the height of the texture subimage.
        /// </param>
        public static void CopyTexSubImage3D(TextureTarget target, int level, int xoffset, int yoffset, int zoffset,
        ...
        /// </param>
        public static void DrawArraysInstancedBaseInstance(BeginMode mode, int first, int count, int primcount,
            uint baseinstance)
        {
        ...
        /// </param>
        public static void DrawElementsBaseVertex(BeginMode mode, int count, DrawElementsType type, IntPtr indices,
            int basevertex)
        {
        ...
        ///     Specifies the number of instances of the specified range of indices to be rendered.
        /// </param>
        public static void DrawElementsInstanced(BeginMode mode, int count, DrawElementsType type, IntPtr indices,
            int primcount)
        {
        ...
        public static void DrawElementsInstancedBaseVertexBaseInstance(BeginMode mode, int count, DrawElementsType type,
            IntPtr indices, int primcount, int basevertex, uint baseinstance)
        {
            Delegates.glDrawElementsInstancedBaseVertexBaseInstance(mode, count, type, indices, primcount, basevertex,
                baseinstance);
        }
        ...
        ///     Specifies a pointer to the location where the indices are stored.
        /// </param>
        public static void DrawRangeElements(BeginMode mode, uint start, uint end, int count, DrawElementsType type,
            IntPtr indices)
        {
        ...
        ///     enabled vertex arrays.
        /// </param>
        public static void DrawRangeElementsBaseVertex(BeginMode mode, uint start, uint end, int count,
        ...
        /// <summary>
        ///     Render multiple instances of primitives using a count derived from a specifed stream of a transform feedback
        ///     object.
        ///     <para>
        ...
        /// </param>
        public static void FramebufferTexture(FramebufferTarget target, FramebufferAttachment attachment, uint texture,
            int level)
        {
        ...
        ///     Specifies the mipmap level of the texture object to attach.
        /// </param>
        public static void FramebufferTexture1D(FramebufferTarget target, FramebufferAttachment attachment,
        ...
        /// <param name="layer">
        /// </param>
        public static void FramebufferTexture3D(FramebufferTarget target, FramebufferAttachment attachment,
        ...
        /// </param>
        public static void FramebufferTextureLayer(FramebufferTarget target, FramebufferAttachment attachment,
        ...
        ///     Specifies the layer of the texture object to attach.
        /// </param>
        public static void NamedFramebufferTextureLayer(uint framebuffer, FramebufferAttachment attachment,
            uint texture, int level, int layer)
        {
        ...
        /// </param>
        public static void GetActiveAtomicCounterBufferiv(uint program, uint bufferIndex,
        ...
        /// </param>
        public static void GetActiveAttrib(uint program, uint index, int bufSize, [OutAttribute] int[] length,
        ...
        ///     Returns a null terminated string containing the name of the attribute variable.
        /// </param>
        public static void GetActiveAttrib(uint program, int index, int bufSize, [OutAttribute] int[] length,
            [OutAttribute] int[] size, [OutAttribute] ActiveAttribType[] type, [OutAttribute] StringBuilder name)
        {
            if (index < 0) throw new ArgumentOutOfRangeException("index");
        ...
        /// </param>
        public static void GetActiveSubroutineUniformiv(uint program, ShaderType shadertype, uint index,
        ...
        /// </param>
        public static void GetActiveUniform(uint program, uint index, int bufSize, [OutAttribute] int[] length,
        ...
        ///     Returns a null terminated string containing the name of the uniform variable.
        /// </param>
        public static void GetActiveUniform(uint program, int index, int bufSize, [OutAttribute] int[] length,
            [OutAttribute] int[] size, [OutAttribute] ActiveUniformType[] type, [OutAttribute] StringBuilder name)
        {
            if (index < 0) throw new ArgumentOutOfRangeException("index");
        ...
        /// </param>
        public static void GetActiveUniformBlockiv(uint program, uint uniformBlockIndex,
        ...
        /// </param>
        public static void GetActiveUniformsiv(uint program, int uniformCount, [OutAttribute] uint[] uniformIndices,
            ActiveUniformType pname, [OutAttribute] int[] @params)
        {
        ...
        /// </param>
        public static void GetAttachedShaders(uint program, int maxCount, [OutAttribute] int[] count,
        ...
        /// </param>
        public static void GetBufferParameteriv(BufferTarget target, BufferParameterName value,
        ...
        ///     Returns the requested parameter.
        /// </param>
        public static void GetBufferParameteri64v(BufferTarget target, BufferParameterName value,
        ...
        /// <param name="params">
        /// </param>
        public static void GetNamedBufferParameteriv(uint buffer, BufferParameterName pname,
        ...
        /// <param name="params">
        /// </param>
        public static void GetNamedBufferParameteri64v(uint buffer, BufferParameterName pname,
        ...
        ///     Returns the compressed texture image.
        /// </param>
        public static void GetnCompressedTexImage(TextureTarget target, int level, int bufSize,
        ...
        public static void GetCompressedTextureSubImage(uint texture, int level, int xoffset, int yoffset, int zoffset,
            int width, int height, int depth, int bufSize, [OutAttribute] IntPtr pixels)
        {
            Delegates.glGetCompressedTextureSubImage(texture, level, xoffset, yoffset, zoffset, width, height, depth,
                bufSize, pixels);
        }
        ...
        /// </param>
        public static void GetFramebufferAttachmentParameteriv(FramebufferTarget target,
        ...
        ///     Returns the value of parameter pname for attachment.
        /// </param>
        public static void GetNamedFramebufferAttachmentParameteriv(uint framebuffer, FramebufferAttachment attachment,
            FramebufferParameterName pname, [OutAttribute] int[] @params)
        {
        ...
        /// </param>
        public static void GetFramebufferParameteriv(FramebufferTarget target, FramebufferPName pname,
            [OutAttribute] int[] @params)
        {
        ...
        /// <param name="param">
        /// </param>
        public static void GetNamedFramebufferParameteriv(uint framebuffer, FramebufferPName pname,
        ...
        ///     Specifies the address of a variable into which to write the retrieved information.
        /// </param>
        public static void GetInternalformativ(TextureTarget target, PixelInternalFormat internalFormat, GetPName pname,
            int bufSize, [OutAttribute] int[] @params)
        {
        ...
        ///     Specifies the address of a variable into which to write the retrieved information.
        /// </param>
        public static void GetInternalformati64v(TextureTarget target, PixelInternalFormat internalFormat,
        ...
        /// </param>
        public static void GetObjectLabel(ObjectLabel identifier, uint name, int bufSize, [OutAttribute] int[] length,
            [OutAttribute] StringBuilder label)
        {
        ...
        ///     The address of a string that will receive the object label.
        /// </param>
        public static void GetObjectPtrLabel([OutAttribute] IntPtr ptr, int bufSize, [OutAttribute] int[] length,
            [OutAttribute] StringBuilder label)
        {
        ...
        /// </param>
        public static void GetProgramBinary(uint program, int bufsize, [OutAttribute] int[] length,
        ...
        /// </param>
        public static void GetProgramInfoLog(uint program, int maxLength, [OutAttribute] int[] length,
        ...
        ///     pipeline.
        /// </param>
        public static void GetProgramPipelineInfoLog(uint pipeline, int bufSize, [OutAttribute] int[] length,
            [OutAttribute] StringBuilder infoLog)
        {
        ...
        {
            Delegates.glGetProgramResourceiv(program, programInterface, index, propCount, props, bufSize, length,
                @params);
        }
        ...
        /// </param>
        public static void GetProgramStageiv(uint program, ShaderType shadertype, ProgramStageParameterName pname,
        ...
        /// </param>
        public static void GetQueryIndexediv(QueryTarget target, uint index, GetQueryParam pname,
            [OutAttribute] int[] @params)
        {
        ...
        /// </param>
        public static void GetRenderbufferParameteriv(RenderbufferTarget target, RenderbufferParameterName pname,
            [OutAttribute] int[] @params)
        {
        ...
        ///     Returns the value of parameter pname for the renderbuffer object.
        /// </param>
        public static void GetNamedRenderbufferParameteriv(uint renderbuffer, RenderbufferParameterName pname,
            [OutAttribute] int[] @params)
        {
        ...
        /// </param>
        public static void GetSamplerParameterfv(uint sampler, TextureParameterName pname,
        ...
        ///     Returns the sampler parameters.
        /// </param>
        public static void GetSamplerParameterIiv(uint sampler, TextureParameterName pname,
            [OutAttribute] int[] @params)
        {
        ...
        ///     Returns the sampler parameters.
        /// </param>
        public static void GetSamplerParameterIuiv(uint sampler, TextureParameterName pname,
        ...
        ///     Specifies an array of characters that is used to return the information log.
        /// </param>
        public static void GetShaderInfoLog(uint shader, int maxLength, [OutAttribute] int[] length,
            [OutAttribute] StringBuilder infoLog)
        {
        ...
        ///     written.
        /// </param>
        public static void GetShaderPrecisionFormat(ShaderType shaderType, int precisionType,
        ...
        /// </param>
        public static void GetShaderSource(uint shader, int bufSize, [OutAttribute] int[] length,
        ...
        /// </param>
        public static void GetSynciv(IntPtr sync, ArbSync pname, int bufSize, [OutAttribute] int[] length,
            [OutAttribute] int[] values)
        {
        ...
        /// </param>
        public static void GetTexImage(TextureTarget target, int level, PixelFormat format, PixelType type,
            [OutAttribute] IntPtr pixels)
        {
        ...
        ///     Returns the texture image. Should be a pointer to an array of the type specified by type.
        /// </param>
        public static void GetnTexImage(TextureTarget target, int level, PixelFormat format, PixelType type,
        ...
        ///     Returns the texture image. Should be a pointer to an array of the type specified by type.
        /// </param>
        public static void GetTextureImage(uint texture, int level, PixelFormat format, PixelType type, int bufSize,
            [OutAttribute] IntPtr pixels)
        {
        ...
        ///     Returns the requested data.
        /// </param>
        public static void GetTexLevelParameterfv(GetPName target, int level, GetTextureLevelParameter pname,
            [OutAttribute] float[] @params)
        {
        ...
        ///     Returns the requested data.
        /// </param>
        public static void GetTexLevelParameteriv(TextureTarget target, int level, GetTextureLevelParameter pname,
            [OutAttribute] int[] @params)
        {
        ...
        ///     Returns the requested data.
        /// </param>
        public static void GetTextureLevelParameterfv(uint texture, int level, GetTextureLevelParameter pname,
            [OutAttribute] float[] @params)
        {
        ...
        ///     Returns the requested data.
        /// </param>
        public static void GetTextureLevelParameteriv(uint texture, int level, GetTextureLevelParameter pname,
            [OutAttribute] int[] @params)
        {
        ...
        /// </param>
        public static void GetTexParameterfv(TextureTarget target, GetTextureParameter pname,
            [OutAttribute] float[] @params)
        {
        ...
        ///     Returns the texture parameters.
        /// </param>
        public static void GetTexParameteriv(TextureTarget target, GetTextureParameter pname,
            [OutAttribute] int[] @params)
        {
        ...
        ///     Returns the texture parameters.
        /// </param>
        public static void GetTexParameterIiv(TextureTarget target, GetTextureParameter pname,
            [OutAttribute] int[] @params)
        {
        ...
        ///     Returns the texture parameters.
        /// </param>
        public static void GetTexParameterIuiv(TextureTarget target, GetTextureParameter pname,
            [OutAttribute] uint[] @params)
        {
        ...
        ///     Returns the texture parameters.
        /// </param>
        public static void GetTextureParameterfv(uint texture, GetTextureParameter pname,
            [OutAttribute] float[] @params)
        {
        ...
        ///     Returns the texture parameters.
        /// </param>
        public static void GetTextureParameterIuiv(uint texture, GetTextureParameter pname,
            [OutAttribute] uint[] @params)
        {
        ...
        public static void GetTextureSubImage(uint texture, int level, int xoffset, int yoffset, int zoffset, int width,
            int height, int depth, PixelFormat format, PixelType type, int bufSize, [OutAttribute] IntPtr pixels)
        {
            Delegates.glGetTextureSubImage(texture, level, xoffset, yoffset, zoffset, width, height, depth, format,
                type, bufSize, pixels);
        }
        ...
        /// </param>
        public static void GetTransformFeedbackiv(uint xfb, TransformFeedbackParameterName pname,
            [OutAttribute] int[] param)
        {
        ...
        ///     The address of a buffer into which will be written the requested state information.
        /// </param>
        public static void GetTransformFeedbacki_v(uint xfb, TransformFeedbackParameterName pname, uint index,
            [OutAttribute] int[] param)
        {
        ...
        ///     The address of a buffer into which will be written the requested state information.
        /// </param>
        public static void GetTransformFeedbacki64_v(uint xfb, TransformFeedbackParameterName pname, uint index,
        ...
        /// </param>
        public static void GetUniformIndices(uint program, int uniformCount, string uniformNames,
        ...
        /// </param>
        public static void GetVertexArrayIndexed64iv(uint vaobj, uint index, VertexAttribParameter pname,
            [OutAttribute] long[] param)
        {
        ...
        ///     Returns the requested value.
        /// </param>
        public static void GetVertexArrayIndexediv(uint vaobj, uint index, VertexAttribParameter pname,
            [OutAttribute] int[] param)
        {
        ...
        /// </param>
        public static void GetVertexAttribPointerv(uint index, VertexAttribPointerParameter pname,
        ...
        /// </param>
        public static void InvalidateFramebuffer(FramebufferTarget target, int numAttachments,
        ...
        ///     Specifies a pointer to an array identifying the attachments to be invalidated.
        /// </param>
        public static void InvalidateNamedFramebufferData(uint framebuffer, int numAttachments,
            FramebufferAttachment[] attachments)
        {
        ...
        public static void InvalidateNamedFramebufferSubData(uint framebuffer, int numAttachments,
            FramebufferAttachment[] attachments, int x, int y, int width, int height)
        {
            Delegates.glInvalidateNamedFramebufferSubData(framebuffer, numAttachments, attachments, x, y, width,
                height);
        }
        ...
        /// </param>
        public static void MultiDrawElements(BeginMode mode, int[] count, DrawElementsType type, IntPtr indices,
            int drawcount)
        {
        ...
        /// <summary>
        ///     Render multiple sets of primitives by specifying indices of array data elements and an index to apply to each
        ///     index.
        ///     <para>
        ...
        /// </param>
        public static void MultiDrawElementsBaseVertex(BeginMode mode, int[] count, DrawElementsType type,
        ...
        ///     Specifies the distance in basic machine units between elements of the draw parameter array.
        /// </param>
        public static void MultiDrawElementsIndirect(BeginMode mode, DrawElementsType type, IntPtr indirect,
        ...
        /// </param>
        public static void ProgramParameteri(uint program, Version32 pname, int value)
        {
        ...
        ///     used to update the specified uniform variable.
        /// </param>
        public static void ProgramUniformMatrix2x3fv(uint program, int location, int count, bool transpose,
            float[] value)
        {
        ...
        ///     used to update the specified uniform variable.
        /// </param>
        public static void ProgramUniformMatrix3x2fv(uint program, int location, int count, bool transpose,
            float[] value)
        {
        ...
        ///     used to update the specified uniform variable.
        /// </param>
        public static void ProgramUniformMatrix2x4fv(uint program, int location, int count, bool transpose,
            float[] value)
        {
        ...
        ///     used to update the specified uniform variable.
        /// </param>
        public static void ProgramUniformMatrix4x2fv(uint program, int location, int count, bool transpose,
            float[] value)
        {
        ...
        ///     used to update the specified uniform variable.
        /// </param>
        public static void ProgramUniformMatrix3x4fv(uint program, int location, int count, bool transpose,
            float[] value)
        {
        ...
        ///     used to update the specified uniform variable.
        /// </param>
        public static void ProgramUniformMatrix4x3fv(uint program, int location, int count, bool transpose,
            float[] value)
        {
        ...
        /// </param>
        public static void ReadPixels(int x, int y, int width, int height, PixelFormat format, PixelType type,
            int[] data)
        {
        ...
        ///     Returns the pixel data.
        /// </param>
        public static void ReadnPixels(int x, int y, int width, int height, PixelFormat format, PixelType type,
        ...
        /// </param>
        public static void RenderbufferStorage(RenderbufferTarget target, RenderbufferStorage internalFormat, int width,
            int height)
        {
        ...
        ///     Specifies the height of the renderbuffer, in pixels.
        /// </param>
        public static void NamedRenderbufferStorage(uint renderbuffer, RenderbufferStorage internalFormat, int width,
            int height)
        {
        ...
        /// </param>
        public static void TexBufferRange(BufferTarget target, SizedInternalFormat internalFormat, uint buffer,
        ...
        ///     Specifies the size of the range of the buffer's data store to attach.
        /// </param>
        public static void TextureBufferRange(uint texture, SizedInternalFormat internalFormat, uint buffer,
        ...
        /// </param>
        public static void TexImage1D(TextureTarget target, int level, PixelInternalFormat internalFormat, int width,
        ...
        public static void TexImage3D(TextureTarget target, int level, PixelInternalFormat internalFormat, int width,
            int height, int depth, int border, PixelFormat format, PixelType type, IntPtr data)
        {
        ...
        ///     the image.
        /// </param>
        public static void TexImage3DMultisample(TextureTargetMultisample target, int samples,
            PixelInternalFormat internalFormat, int width, int height, int depth, bool fixedsamplelocations)
        {
            Delegates.glTexImage3DMultisample(target, samples, internalFormat, width, height, depth,
        ...
        /// </param>
        public static void TexStorage2D(TextureTarget target, int levels, SizedInternalFormat internalFormat, int width,
            int height)
        {
        ...
        ///     the image.
        /// </param>
        public static void TextureStorage2DMultisample(uint texture, int samples, SizedInternalFormat internalFormat,
            int width, int height, bool fixedsamplelocations)
        {
            Delegates.glTextureStorage2DMultisample(texture, samples, internalFormat, width, height,
                fixedsamplelocations);
        }

        /// <summary>
        ///     Simultaneously specify storage for all levels of a three-dimensional, two-dimensional array or cube-map array
        ///     texture.
        ///     <para>
        ...
        /// </param>
        public static void TexStorage3D(TextureTarget target, int levels, SizedInternalFormat internalFormat, int width,
        ...
        ///     the image.
        /// </param>
        public static void TexStorage3DMultisample(TextureTarget target, int samples,
            SizedInternalFormat internalFormat, int width, int height, int depth, bool fixedsamplelocations)
        {
            Delegates.glTexStorage3DMultisample(target, samples, internalFormat, width, height, depth,
                fixedsamplelocations);
        }
        ...
        {
            Delegates.glTextureStorage3DMultisample(texture, samples, internalFormat, width, height, depth,
                fixedsamplelocations);
        }
        ...
        ///     Specifies a pointer to the image data in memory.
        /// </param>
        public static void TexSubImage1D(TextureTarget target, int level, int xoffset, int width, PixelFormat format,
        ...
        {
            Delegates.glTexSubImage3D(target, level, xoffset, yoffset, zoffset, width, height, depth, format, type,
                pixels);
        }
        ...
        public static void TextureSubImage3D(uint texture, int level, int xoffset, int yoffset, int zoffset, int width,
            int height, int depth, PixelFormat format, PixelType type, IntPtr pixels)
        {
            Delegates.glTextureSubImage3D(texture, level, xoffset, yoffset, zoffset, width, height, depth, format, type,
                pixels);
        }
        ...
        {
            Delegates.glTextureView(texture, target, origtexture, internalFormat, minlevel, numlevels, minlayer,
                numlayers);
        }
        ...
        /// </param>
        public static void TransformFeedbackVaryings(uint program, int count, string[] varyings,
        ...
        ///     The distance between elements within the buffer.
        /// </param>
        public static void VertexAttribFormat(uint attribindex, int size, VertexAttribFormat type, bool normalized,
            uint relativeoffset)
        {
        ...
        ///     The distance between elements within the buffer.
        /// </param>
        public static void VertexArrayAttribIFormat(uint vaobj, uint attribindex, int size, VertexAttribFormat type,
            uint relativeoffset)
        {
        ...
        ///     The distance between elements within the buffer.
        /// </param>
        public static void VertexArrayAttribLFormat(uint vaobj, uint attribindex, int size, VertexAttribFormat type,
            uint relativeoffset)
        {
        ...
        ///     data store of the buffer currently bound to the GL_ARRAY_BUFFER target. The initial value is 0.
        /// </param>
        public static void VertexAttribIPointer(uint index, int size, VertexAttribPointerType type, int stride,
            IntPtr pointer)
        {
        ...
        ///     data store of the buffer currently bound to the GL_ARRAY_BUFFER target. The initial value is 0.
        /// </param>
        public static void VertexAttribLPointer(uint index, int size, VertexAttribPointerType type, int stride,
            IntPtr pointer)
        {
