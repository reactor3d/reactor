...
namespace Reactor.Platform.BGFX
{
    public static partial class bgfx
    {
        ...
        public enum DebugFlags : uint
        {
	        ...
	        /// <summary>
	        ///     Enable profiler. This causes per-view statistics to be collected, available through `bgfx::Stats::ViewStats`. This
	        ///     is unrelated to the profiler functions in `bgfx::CallbackI`.
	        /// </summary>
	        Profiler = 0x00000010
        }
        ...
        ///     When using fixed point AttribType (f.e. Uint8) value will be normalized for vertex shader
        ///     usage. When normalized is set to true, AttribType::Uint8 value in range 0-255 will be in range 0.0-1.0 in vertex
        ///     shader.
        /// </param>
        /// <param name="_asInt">
        ///     Packaging rule for vertexPack, vertexUnpack, and vertexConvert for AttribType::Uint8 and
        ///     AttribType::Int16. Unpacking code must be implemented inside vertex shader.
        /// </param>
        ...
        /// <param name="_dst">
        ///     Destination index buffer. If this argument is NULL function will return number of indices after
        ///     conversion.
        /// </param>
        /// <param name="_dstSize">
        ///     Destination index buffer in bytes. It must be large enough to contain output indices. If
        ///     destination size is insufficient index buffer will be truncated.
        /// </param>
        ...
        ///     Pointer to first vertex represented as float x, y, z. Must contain at least number of vertices
        ...
        /// <param name="_flags">
        ///     See: `BGFX_RESET_*` for more info.   - `BGFX_RESET_NONE` - No reset flags.   -
        ///     `BGFX_RESET_FULLSCREEN` - Not supported yet.   - `BGFX_RESET_MSAA_X[2/4/8/16]` - Enable 2, 4, 8 or 16 x MSAA.   -
        ///     `BGFX_RESET_VSYNC` - Enable V-Sync.   - `BGFX_RESET_MAXANISOTROPY` - Turn on/off max anisotropy.   -
        ///     `BGFX_RESET_CAPTURE` - Begin screen capture.   - `BGFX_RESET_FLUSH_AFTER_RENDER` - Flush rendering after submitting
        ///     to GPU.   - `BGFX_RESET_FLIP_AFTER_RENDER` - This flag  specifies where flip     occurs. Default behaviour is that
        ///     flip occurs before rendering new     frame. This flag only has effect when `BGFX_CONFIG_MULTITHREADED=0`.   -
        ...
        /// </summary>
        /// <param name="_debug">
        ///     Available flags:   - `BGFX_DEBUG_IFH` - Infinitely fast hardware. When this flag is set     all
        ///     rendering calls will be skipped. This is useful when profiling     to quickly assess potential bottlenecks between
        ///     CPU and GPU.   - `BGFX_DEBUG_PROFILER` - Enable profiler.   - `BGFX_DEBUG_STATS` - Display internal statistics.   -
        ///     `BGFX_DEBUG_TEXT` - Display debug text.   - `BGFX_DEBUG_WIREFRAME` - Wireframe rendering. All rendering
        ...
        /// <param name="_attr">
        ///     Color palette. Where top 4-bits represent index of background, and bottom 4-bits represent
        ///     foreground color from standard VGA text palette (ANSI escape codes).
        /// </param>
        ...
        /// <summary>
        ///     Print formatted data from variable argument list to internal debug text character-buffer (VGA-compatible text
        ///     mode).
        /// </summary>
        /// <param name="_x">Position x from the left corner of the window.</param>
        /// <param name="_y">Position y from the top corner of the window.</param>
        ...
        /// <param name="_flags">
        ///     Buffer creation flags.   - `BGFX_BUFFER_NONE` - No flags.   - `BGFX_BUFFER_COMPUTE_READ` - Buffer
        ///     will be read from by compute shader.   - `BGFX_BUFFER_COMPUTE_WRITE` - Buffer will be written into by compute
        ///     shader. When buffer       is created with `BGFX_BUFFER_COMPUTE_WRITE` flag it cannot be updated from CPU.   -
        ///     `BGFX_BUFFER_COMPUTE_READ_WRITE` - Buffer will be used for read/write by compute shader.   -
        ///     `BGFX_BUFFER_ALLOW_RESIZE` - Buffer will resize on buffer update if a different amount of       data is passed. If
        ///     this flag is not specified, and more data is passed on update, the buffer       will be trimmed to fit the existing
        ///     buffer size. This flag has effect only on dynamic       buffers.   - `BGFX_BUFFER_INDEX32` - Buffer is using 32-bit
        ///     indices. This flag has effect only on       index buffers.
        /// </param>
        ...
        /// <param name="_len">
        ///     Static index buffer name length (if length is INT32_MAX, it's expected that _name is zero terminated
        ///     string.
        /// </param>
        ...
        /// <param name="_len">
        ///     Static vertex buffer name length (if length is INT32_MAX, it's expected that _name is zero
        ///     terminated string.
        /// </param>
        ...
        [DllImport(DllName, EntryPoint = "bgfx_get_avail_transient_index_buffer",
            CallingConvention = CallingConvention.Cdecl)]
        public static extern uint get_avail_transient_index_buffer(uint _num, bool _index32);
        ...
        /// </summary>
        /// <param name="_tib">
        ///     TransientIndexBuffer structure will be filled, and will be valid for the duration of frame, and can
        ///     be reused for multiple draw calls.
        /// </param>
        ...
        /// </summary>
        /// <param name="_tvb">
        ///     TransientVertexBuffer structure will be filled, and will be valid for the duration of frame, and can
        ///     be reused for multiple draw calls.
        /// </param>
        ...
        /// </summary>
        /// <param name="_idb">
        ///     InstanceDataBuffer structure will be filled, and will be valid for duration of frame, and can be
        ...
        public static extern void set_shader_name(ShaderHandle _handle, [MarshalAs(UnmanagedType.LPStr)] string _name,
            int _len);
        ...
        [return: MarshalAs(UnmanagedType.I1)]
        public static extern bool is_texture_valid(ushort _depth, bool _cubeMap, ushort _numLayers,
        ...
        /// <param name="_flags">
        ///     Texture creation (see `BGFX_TEXTURE_*`.), and sampler (see `BGFX_SAMPLER_*`) flags. Default
        ///     texture sampling mode is linear, and wrap mode is repeat. - `BGFX_SAMPLER_[U/V/W]_[MIRROR/CLAMP]` - Mirror or clamp
        ///     to edge wrap   mode. - `BGFX_SAMPLER_[MIN/MAG/MIP]_[POINT/ANISOTROPIC]` - Point or anisotropic   sampling.
        /// </param>
        ...
        ///     Number of layers in texture array. Must be 1 if caps `BGFX_CAPS_TEXTURE_2D_ARRAY` flag is not
        ///     set.
        /// </param>
        /// <param name="_format">Texture format. See: `TextureFormat::Enum`.</param>
        /// <param name="_flags">
        ...
        /// </param>
        /// <param name="_mem">
        ///     Texture data. If `_mem` is non-NULL, created texture will be immutable. If `_mem` is NULL content of
        ///     the texture is uninitialized. When `_numLayers` is more than 1, expected memory layout is texture and all mips
        ...
        public static extern TextureHandle create_texture_2d_scaled(BackbufferRatio _ratio, bool _hasMips,
        ...
        /// <param name="_pitch">
        ///     Pitch of input image (bytes). When _pitch is set to UINT16_MAX, it will be calculated internally
        ///     based on _width.
        /// </param>
        ...
        public static extern void set_texture_name(TextureHandle _handle, [MarshalAs(UnmanagedType.LPStr)] string _name,
            int _len);
        ...
        public static extern FrameBufferHandle create_frame_buffer(ushort _width, ushort _height, TextureFormat _format,
            ulong _textureFlags);
        ...
        [DllImport(DllName, EntryPoint = "bgfx_create_frame_buffer_scaled",
            CallingConvention = CallingConvention.Cdecl)]
        public static extern FrameBufferHandle create_frame_buffer_scaled(BackbufferRatio _ratio, TextureFormat _format,
            ulong _textureFlags);
        ...
        /// <param name="_len">
        ///     Frame buffer name length (if length is INT32_MAX, it's expected that _name is zero terminated
        ///     string.
        /// </param>
        [DllImport(DllName, EntryPoint = "bgfx_set_frame_buffer_name", CallingConvention = CallingConvention.Cdecl)]
        public static extern void set_frame_buffer_name(FrameBufferHandle _handle,
            [MarshalAs(UnmanagedType.LPStr)] string _name, int _len);
        ...
        public static extern UniformHandle create_uniform([MarshalAs(UnmanagedType.LPStr)] string _name,
        ...
        /// <param name="_result">
        ///     Number of pixels that passed test. This argument can be `NULL` if result of occlusion query is
        ///     not needed.
        /// </param>
        ...
        public static extern void set_view_clear_mrt(ushort _id, ushort _flags, float _depth, byte _stencil, byte _c0,
            byte _c1, byte _c2, byte _c3, byte _c4, byte _c5, byte _c6, byte _c7);
        ...
        /// <param name="_id">View id.</param>
        /// <param name="_handle">
        ///     Frame buffer handle. Passing `BGFX_INVALID_HANDLE` as frame buffer handle will draw primitives
        ///     from this view into default back buffer.
        /// </param>
        ...
        public static extern unsafe void encoder_set_marker(Encoder* _this,
            [MarshalAs(UnmanagedType.LPStr)] string _marker);
        ...
        ///     `BGFX_STATE_DEPTH_TEST_*` - Depth test function.   - `BGFX_STATE_BLEND_*` - See remark 1 about
        ///     BGFX_STATE_BLEND_FUNC.   - `BGFX_STATE_BLEND_EQUATION_*` - See remark 2.   - `BGFX_STATE_CULL_*` - Backface culling
        ///     mode.   - `BGFX_STATE_WRITE_*` - Enable R, G, B, A or Z write.   - `BGFX_STATE_MSAA` - Enable hardware multisample
        ///     antialiasing.   - `BGFX_STATE_PT_[TRISTRIP/LINES/POINTS]` - Primitive type.
        /// </param>
        /// <param name="_rgba">
        ///     Sets blend factor used by `BGFX_STATE_BLEND_FACTOR` and   `BGFX_STATE_BLEND_INV_FACTOR` blend
        ///     modes.
        /// </param>
        ...
        ///     Back stencil state. If back is set to `BGFX_STENCIL_NONE` _fstencil is applied to both front
        ...
        ///     Vertex layout for aliasing vertex buffer. If invalid handle is used, vertex layout used for
        ///     creation of vertex buffer will be used.
        /// </param>
        ...
        /// <param name="_indirectHandle">Indirect buffer.</param>
        /// <param name="_start">First element in indirect buffer.</param>
        /// <param name="_numHandle">
        ///     Buffer for number of draws. Must be   created with `BGFX_BUFFER_INDEX32` and
        ...
        public static extern unsafe void encoder_submit_indirect_count(Encoder* _this, ushort _id,
            ProgramHandle _program, IndirectBufferHandle _indirectHandle, ushort _start, IndexBufferHandle _numHandle,
            uint _numIndex, ushort _numMax, uint _depth, byte _flags);
        ...
        /// <param name="_dstZ">
        ///     If texture is 2D this argument should be 0. If destination texture is cube this argument represents
        ///     destination texture cube face. For 3D texture this argument represents destination texture Z position.
        /// </param>
        ...
        /// <param name="_srcZ">
        ///     If texture is 2D this argument should be 0. If source texture is cube this argument represents
        ///     source texture cube face. For 3D texture this argument represents source texture Z position.
        /// </param>
        ...
        /// </summary>
        /// <param name="_handle">
        ///     Frame buffer handle. If handle is `BGFX_INVALID_HANDLE` request will be made for main window back
        ///     buffer.
        /// </param>
        ...
        public static extern void request_screen_shot(FrameBufferHandle _handle,
        ...
        public static extern UIntPtr override_internal_texture(TextureHandle _handle, ushort _width, ushort _height,
        ...
        [DllImport(DllName, EntryPoint = "bgfx_set_vertex_buffer_with_layout",
            CallingConvention = CallingConvention.Cdecl)]
        public static extern void set_vertex_buffer_with_layout(byte _stream, VertexBufferHandle _handle,
        ...
        [DllImport(DllName, EntryPoint = "bgfx_set_dynamic_vertex_buffer_with_layout",
            CallingConvention = CallingConvention.Cdecl)]
        public static extern void set_dynamic_vertex_buffer_with_layout(byte _stream, DynamicVertexBufferHandle _handle,
            uint _startVertex, uint _numVertices, VertexLayoutHandle _layoutHandle);
        ...
        public static extern void submit_indirect_count(ushort _id, ProgramHandle _program,
        ...
        public static extern void blit(ushort _id, TextureHandle _dst, byte _dstMip, ushort _dstX, ushort _dstY,
