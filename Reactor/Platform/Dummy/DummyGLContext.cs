...
namespace Reactor.Platform.Dummy
{
    ...
    internal sealed class DummyGLContext : GraphicsContextBase
    {
        ...
        {
            #if OPENGL
            new Reactor.Graphics.OpenGL.GL().LoadEntryPoints();
            new Reactor.Graphics.OpenGL4.GL().LoadEntryPoints();
            #endif
            #if OPENGLES
            new Reactor.Graphics.ES11.GL().LoadEntryPoints();
            new Reactor.Graphics.ES20.GL().LoadEntryPoints();
            new Reactor.Graphics.ES30.GL().LoadEntryPoints();
            #endif
        }
