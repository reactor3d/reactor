...
namespace Reactor.Platform
{
    ...
    public static class Utilities
    {
        ...
        {
            #if X11
            Platform.X11.X11WindowInfo window = new Reactor.Platform.X11.X11WindowInfo();
        ...
        {
            #if WIN32
            return new Reactor.Platform.Windows.WinWindowInfo(windowHandle, null);
            #else
            return new Dummy.DummyWindowInfo();
            #endif
        }
        ...
        /// <returns>A new IWindowInfo instance.</returns>
        public static IWindowInfo CreateMacOSCarbonWindowInfo(IntPtr windowHandle, bool ownHandle, bool isControl,
            Reactor.Platform.MacOS.GetInt xOffset, Reactor.Platform.MacOS.GetInt yOffset)
        {
            return new Reactor.Platform.MacOS.CarbonWindowInfo(windowHandle, false, isControl, xOffset, yOffset);
        }
        #endif
        ...
        {
            #if CARBON
            return new Reactor.Platform.MacOS.CocoaWindowInfo(windowHandle);
            #else
            return new Dummy.DummyWindowInfo();
            #endif
        }
        ...
        {
            #if CARBON
            return new Reactor.Platform.MacOS.CocoaWindowInfo(windowHandle, viewHandle);
            #else
            return new Dummy.DummyWindowInfo();
            #endif
        }
        ...
        {
            return new Reactor.Platform.SDL2.Sdl2WindowInfo(
                windowHandle, null);
        }
        ...
        internal static bool RelaxGraphicsMode(ref ColorFormat color, ref int depth, ref int stencil, ref int samples, ref ColorFormat accum, ref int buffers, ref bool stereo)
        {
            ...
            if (samples > 0)
            {
                samples = System.Math.Max(samples - 1, 0);
                return true;
            }
