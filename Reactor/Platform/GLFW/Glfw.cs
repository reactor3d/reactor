...
namespace Reactor.Platform.GLFW
{
    ...
    public static class Glfw
    {
        ...
        public static extern int GetKeyScanCode(RKey key);
        ...
        public static extern InputState GetKey(Window window, RKey key);

        [DllImport(LIBRARY, EntryPoint = "glfwGetKeyName", CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr GetKeyNameInternal(RKey key, int scanCode);
        ...
        public static string GetKeyName(RKey key, int scanCode)
        {
