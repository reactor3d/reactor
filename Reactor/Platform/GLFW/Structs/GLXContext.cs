...
namespace Reactor.Platform.GLFW
{
    ...
    public struct GLXContext : IEquatable<GLXContext>
    {
        ...
        /// </returns>
        public static implicit operator IntPtr(GLXContext context)
        {
        ...
        /// </returns>
        public bool Equals(GLXContext other)
        {
        ...
        /// </returns>
        public static bool operator ==(GLXContext left, GLXContext right)
        {
