...
namespace Reactor.Platform.GLFW
{
    ...
    public struct OSMesaContext : IEquatable<OSMesaContext>
    {
        ...
        /// </returns>
        public static implicit operator IntPtr(OSMesaContext context)
        {
        ...
        /// </returns>
        public bool Equals(OSMesaContext other)
        {
        ...
        /// </returns>
        public static bool operator ==(OSMesaContext left, OSMesaContext right)
        {
