...
namespace Reactor.Platform.GLFW
{
    ...
    public struct NSOpenGLContext : IEquatable<NSOpenGLContext>
    {
        ...
        /// </returns>
        public static implicit operator IntPtr(NSOpenGLContext context)
        {
        ...
        /// </returns>
        public bool Equals(NSOpenGLContext other)
        {
        ...
        /// </returns>
        public static bool operator ==(NSOpenGLContext left, NSOpenGLContext right)
        {
